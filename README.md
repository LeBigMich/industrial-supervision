Projet réalisé par Michel Spruyt et Maxence Herbomel.
Promotion : I5 FISA PAUC
...
2. Créer le fichier d’environnement backend (si nécessaire) :

cp backend/.env.example backend/.env

Adapter les paramètres de connexion à la base (host, port, user, password, database).

3. Construire et lancer les services avec Docker :
...
1. Configurer les paramètres via le bouton “Ajouter un paramètre” :
